...
{
  "contentType": "video",
  "title": "Le défi des deux challenges ML de MyTwin Leaderboard",
  "caption": "Coulisses de MarvelousDev : je me lance un défi autour de MyTwin Leaderboard. L’objectif : reprendre contact avec les contributeurs de lab qui font du ML et les orienter vers deux challenges ouverts : mammography classification et mammography segmentation. Je vous montre ma méthode, mes premières tentatives et le résultat de la semaine. #MyTwinLeaderboard #MarvelousDev #Coulisses #MachineLearning #MLChallenge",
  "hashtags": [
    "#MarvelousDev",
    "#MyTwinLeaderboard",
    "#Coulisses",
  ...
  "hookVisual": "Je me filme face caméra devant mon écran, avec MyTwin Leaderboard ouvert et les deux challenges affichés. Je pointe successivement vers « mammography classification » et « mammography segmentation », puis je lance un minuteur à l’écran.",
  "hookText": "DÉFI : réussir à mobiliser les contributeurs ML sur 2 challenges",
  "hookAudio": "« Cette semaine, je me lance un défi : relancer les contributeurs ML de MyTwin Lab autour de deux challenges ouverts. »",
  "storyboard": [
    {
      "planNumber": 1,
      "description": "Face caméra, j’annonce le défi et j’affiche MyTwin Leaderboard sur mon écran. Je précise que je dispose de 7 heures cette semaine pour avancer sur ce sujet."
    },
    {
      "planNumber": 2,
      "description": "Capture d’écran ou plan de l’écran : je montre les deux challenges ouverts, « mammography classification » et « mammography segmentation ». Texte à l’écran : « Règle n°1 : mobiliser les bons profils ML »."
    },
    {
      "planNumber": 3,
      "description": "Je montre ma préparation : liste des contributeurs à recontacter, brouillon de message et calendrier de la semaine. Je rappelle qu’il y a 60 contributeurs de lab au total, sans afficher d’informations personnelles."
    },
    {
      "planNumber": 4,
      "description": "Je filme les premières tentatives : rédaction d’un message, recherche des contributeurs qui font du ML et envoi des premiers contacts. Texte à l’écran : « Règle n°2 : reprendre contact, une personne à la fois »."
    },
    {
      "planNumber": 5,
      "description": "Face caméra, je partage mon angle personnel : je ne veux pas seulement construire le produit, je veux aussi créer les conditions pour que les bons contributeurs puissent participer aux challenges."
    },
    {
      "planNumber": 6,
      "description": "Je fais un point d’étape devant l’écran : je coche les personnes contactées dans ma liste. Si je n’ai pas encore de réponse ou de résultat mesurable, j’affiche littéralement « Résultat : [à compléter] » plutôt que d’en inventer un."
    },
    {
      "planNumber": 7,
      "description": "Je révèle le résultat final de la semaine avec une capture de MyTwin Leaderboard et une synthèse à compléter : « Contributeurs ML relancés : [à compléter] » et « Prochaine étape : [à compléter] »."
    },
    {
      "planNumber": 8,
      "description": "Conclusion face caméra : « Pour moi, développer un produit ludique, ce n’est pas uniquement coder une plateforme. C’est aussi créer l’envie de participer. Je vous montre la suite dans la prochaine étape de MyTwin Leaderboard. » J’invite les spectateurs à commenter le prochain défi à suivre."
    }
  ],
  "soundRecommendation": "Musique instrumentale légère et énergique, avec un rythme de progression pour accompagner le minuteur, les coches et les captures d’écran. Garder la voix face caméra clairement audible et éviter un son tendance précis non fourni."
}
```
