...
{
  "contentType": "video",
  "title": "Je relance les experts ML de MarvelousDev sur deux défis mammographie",
  "caption": "Dans les coulisses de MarvelousDev : je reprends contact avec certains des 60 contributeurs du lab qui font du ML pour les orienter vers deux challenges ouverts : mammography classification et mammography segmentation. Le défi, c’est de reconnecter les bonnes personnes aux bons sujets — sans transformer le lab en simple liste de profils. #MachineLearning #MLOps #Mammography",
  "hashtags": [
    "#MarvelousDev",
    "#MyTwinLeaderboard",
    "#MachineLearning",
  ...
  "hookVisual": "Capture d’écran du lab avec “60 contributeurs”, puis zoom rapide sur les deux intitulés de challenges : mammography classification et mammography segmentation. Je pose mon doigt sur “2 challenges ouverts”.",
  "hookText": "60 contributeurs. 2 challenges. Je dois retrouver les bons.",
  "hookAudio": "« J’ai 60 contributeurs dans le lab… mais pour ces deux challenges, je dois retrouver ceux qui font du ML. »",
  "storyboard": [
    {
      "planNumber": 1,
      "description": "Face caméra, dans les coulisses de MarvelousDev. Dire que je reprends contact avec certains contributeurs du lab."
    },
    {
      "planNumber": 2,
      "description": "Afficher à l’écran le nombre “60 contributeurs” avec une capture ou une maquette de l’espace lab."
    },
    {
      "planNumber": 3,
      "description": "Montrer les règles du défi : retrouver des contributeurs qui font du ML, puis les lancer sur les deux challenges ouverts — classification de mammographies et segmentation de mammographies."
    },
    {
      "planNumber": 4,
      "description": "Filmer une première tentative : parcourir la liste des contributeurs et préparer les prises de contact. Ne pas afficher de données personnelles à l’écran."
    },
    {
      "planNumber": 5,
      "description": "Filmer une deuxième tentative : ouvrir les deux fiches de challenges et vérifier les intitulés “mammography classification” et “mammography segmentation”."
    },
    {
      "planNumber": 6,
      "description": "Face caméra, expliquer que le résultat attendu n’est pas de tout faire seul, mais de remettre les bonnes personnes devant les bons défis ML."
    },
    {
      "planNumber": 7,
      "description": "Révélation finale : afficher les deux challenges côte à côte, avec une checklist “contributeurs ML identifiés” et “prises de contact lancées” — à compléter selon l’avancement réel."
    },
    {
      "planNumber": 8,
      "description": "Conclusion face caméra : « Je vais suivre qui se lance sur quel challenge, et je vous montrerai ce que ça donne côté lab. »"
    }
  ],
  "soundRecommendation": "Voix face caméra et sons de clavier/notifications légers pour garder l’impression de coulisses. Pas besoin de musique forte : le détail des deux challenges et le compte des 60 contributeurs portent l’accroche."
}
```
