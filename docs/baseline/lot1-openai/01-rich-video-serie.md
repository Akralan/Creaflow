...
{
  "contentType": "video",
  "title": "Coulisses du Vendredi — Le défi des 60 contributeurs",
  "caption": "Coulisses du Vendredi chez MarvelousDev : je reprends contact avec certains des 60 contributeurs de lab qui font du ML pour les lancer sur deux challenges ouverts — mammography classification et mammography segmentation. Le vrai défi : remettre les bonnes personnes sur le bon problème. #ML #machinelearning #MLOps #AIproject #MarvelousDev",
  "hashtags": [
    "#fyp",
    "#pourtoi",
    "#coulisses",
  ...
  "hookVisual": "Plan vertical très serré sur une liste de 60 noms à l’écran, puis zoom rapide sur deux cartes intitulées « mammography classification » et « mammography segmentation ».",
  "hookText": "60 contributeurs. 2 challenges ML. Qui va relever le défi ?",
  "hookAudio": "« Cette semaine, je ne relance pas toute la communauté. Je repars de 60 contributeurs… et je cible ceux qui font du ML. »",
  "storyboard": [
    {
      "planNumber": 1,
      "description": "Face caméra, cadrage vertical brut dans l’espace de travail. Dire : « Coulisses du Vendredi : cette semaine, je reprends contact avec certains des 60 contributeurs de lab. » Afficher « 60 contributeurs » en grand."
    },
    {
      "planNumber": 2,
      "description": "Filmer l’écran ou une feuille de travail avec deux intitulés visibles : « mammography classification » et « mammography segmentation ». Ajouter un effet de surlignage successif sur chaque challenge."
    },
    {
      "planNumber": 3,
      "description": "Retour face caméra. Expliquer : « Mon défi, c’est de lancer les contributeurs ML sur ces deux challenges ouverts. » Afficher « Défi : 2 challenges ouverts »."
    },
    {
      "planNumber": 4,
      "description": "Montrer une première tentative de prise de contact : ouvrir un brouillon de message ou une liste de personnes ciblées, sans afficher de données personnelles. Faire un montage rapide de plusieurs clics ou lignes préparées."
    },
    {
      "planNumber": 5,
      "description": "Montrer une deuxième tentative : hésitation, correction ou réécriture du message avant envoi. Dire en voix off : « Je commence par ceux qui font déjà du ML, plutôt que d’envoyer le même message à tout le monde. »"
    },
    {
      "planNumber": 6,
      "description": "Plan écran sur les deux challenges, puis retour face caméra. Conclusion : « Le résultat du sprint, ce n’est pas encore le classement : c’est d’avoir remis les bonnes personnes en mouvement sur le bon problème. Vendredi prochain, je pourrai montrer jusqu’où ces échanges ont avancé. »"
    },
    {
      "planNumber": 7,
      "description": "Écran final sobre avec « MarvelousDev — Coulisses du Vendredi » et les deux noms des challenges. Inviter les spectateurs à commenter le challenge qu’ils auraient choisi en premier, sans promettre de résultat non confirmé."
    }
  ],
  "soundRecommendation": "Voix face caméra et sons réels de clavier/clics, avec une boucle rythmée et discrète en arrière-plan ; garder la voix clairement dominante pour conserver le côté brut et transparent."
}
```
