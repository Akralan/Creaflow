...
{
  "contentType": "video",
  "concept": "Je montre comment je relance les contributeurs ML de MyTwin Leaderboard autour de deux challenges très concrets — mammography classification et mammography segmentation — sans prétendre déjà connaître le résultat. Le spectateur doit retenir que le sprint du vendredi commence par remettre les bonnes personnes en mouvement, et commenter quelle piste il testerait en premier.",
  "title": "Le duel des 2 challenges mammography",
  "caption": "Coulisses du Vendredi : cette semaine, je remets en mouvement une partie des 60 contributeurs de lab qui travaillent sur le ML. Deux challenges sont ouverts : mammography classification et mammography segmentation.\n\nLe défi du jour n’est pas de faire semblant d’avoir déjà le résultat. C’est de lancer les bonnes personnes sur la bonne piste, puis de voir ce que le sprint produit.\n\nTu commencerais par lequel ? Commente « classification » ou « segmentation ».",
  "hashtags": [
    "#fyp",
    "#techTok",
    "#machinelearning",
    "#MachineLearningFrance",
    "#MLChallenge",
    "#Mammography",
    "#BuildInPublic"
  ],
  ...
  "hookVisual": "Je pose deux feuilles ou deux onglets affichés à l’écran, étiquetés « mammography classification » et « mammography segmentation », puis je fais glisser un jeton vers l’un des deux.",
  "hookText": "60 personnes. 2 défis. Je relance qui en premier ?",
  "hookAudio": "« Cette semaine, je reprends contact avec les contributeurs ML du lab. Mais je ne vais pas lancer les deux pistes au hasard. »",
  "storyboard": [
    {
      "planNumber": 1,
      "description": "Plan vertical serré : je pose côte à côte deux feuilles ou deux écrans avec les textes « mammography classification » et « mammography segmentation », puis je place un jeton au milieu."
    },
    {
      "planNumber": 2,
      "description": "Face caméra, je montre une liste de contacts floutée ou cadrée sans données personnelles et je dis que le lab compte 60 contributeurs, dont certains travaillent sur le ML."
    },
    {
      "planNumber": 3,
      "description": "Capture d’écran verticale ou plan de mon écran : je fais apparaître successivement les deux intitulés « mammography classification » et « mammography segmentation »."
    },
    {
      "planNumber": 4,
      "description": "Face caméra : j’explique que j’ai commencé à reprendre contact avec certains contributeurs de lab pour les lancer sur ces deux challenges ouverts."
    },
    {
      "planNumber": 5,
      "description": "Je montre deux premières tentatives de tri — un jeton sur « classification », puis un jeton sur « segmentation » — avec une coupe rapide entre les deux."
    },
    {
      "planNumber": 6,
      "description": "Je reviens face caméra et je précise que le résultat du sprint n’est pas encore à révéler : le point de départ, c’est d’identifier les contributeurs ML à relancer sur la bonne piste."
    },
    {
      "planNumber": 7,
      "description": "Plan final sur les deux intitulés à l’écran, je place les deux jetons au centre et je pointe vers les commentaires."
    }
  ],
  "soundRecommendation": "Voix off directe, avec un son de notification discret au moment où chaque challenge apparaît, puis une boucle rythmée mais peu présente pour garder les intitulés lisibles. Aucun son tendance précis n’est nécessaire : le brut et la lisibilité servent mieux cette coulisse technique."
}
```
