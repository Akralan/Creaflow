...
- `docs/SPEC_APPRENTISSAGE_STYLE.md` — **cadrage à valider, pas de code.** Exploitation du gisement premier jet / version finale : règles de style apprises, proposées à validation, injectées partout où la machine rédige (y compris micro-retouches, qui ignorent le style aujourd'hui).
